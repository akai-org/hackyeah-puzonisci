...
export const GamePage = () => {
  ...
  const gainers: ProfitGainerProps[] = [
    ...
    },
    {
      ...
      autoClickCost: 7500,
      money,
      internalVals: { time: 300, requiredAmount: 150 },
      updateMoney: setMoney,
      basicUpgradeCost: 20,
      updateVertilizer: setVertilizer,
      cost: 150,
    },
    {
      ...
      autoClickCost: 75000,
      money,
      internalVals: { time: 500, requiredAmount: 500 },
      updateMoney: setMoney,
    ...
    },
    {
      ...
      money,
      internalVals: { time: 1000, requiredAmount: 2000 },
      updateMoney: setMoney,
      basicUpgradeCost: 5000,
      updateVertilizer: setVertilizer,
      cost: 10000,
    },
    {
    ...
    },
    {
      name: 'egg',
      icon: <IoEggOutline />,
      autoClickCost: 1500000,
      money,
      internalVals: { time: 1000, requiredAmount: 50000 },
      updateMoney: setMoney,
      basicUpgradeCost: 20000,
      updateVertilizer: setVertilizer,
      cost: 1000000,
    },
  ];
